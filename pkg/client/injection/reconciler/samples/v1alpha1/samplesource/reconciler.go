...
func (r *reconcilerImpl) updateStatus(ctx context.Context, logger *zap.SugaredLogger, existing *v1alpha1.SampleSource, desired *v1alpha1.SampleSource) error {
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.SampleSource, desiredFinalizers sets.Set[string]) (*v1alpha1.SampleSource, error) {
...
func (r *reconcilerImpl) updateFinalizersFilteredServerSideApply(ctx context.Context, resource *v1alpha1.SampleSource, desiredFinalizers sets.Set[string]) (*v1alpha1.SampleSource, error) {
...
func (r *reconcilerImpl) updateFinalizersFilteredMergePatch(ctx context.Context, resource *v1alpha1.SampleSource, desiredFinalizers sets.Set[string]) (*v1alpha1.SampleSource, error) {
	// Don't modify the informers copy.
...
func (r *reconcilerImpl) clearFinalizer(ctx context.Context, resource *v1alpha1.SampleSource, reconcileEvent reconciler.Event) (*v1alpha1.SampleSource, error) {
	...
	if err != nil {
		...
		getter := r.Client.SamplesV1alpha1().SampleSources(resource.Namespace)
