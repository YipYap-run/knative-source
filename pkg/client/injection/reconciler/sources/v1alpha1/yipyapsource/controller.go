...
import (
	...
	yipyapsource "github.com/YipYap-run/knative-source/pkg/client/injection/informers/sources/v1alpha1/yipyapsource"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "yipyapsource-controller"
	defaultFinalizerName       = "yipyapsources.sources.yipyap.run"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	yipyapsourceInformer := yipyapsource.Get(ctx)

	lister := yipyapsourceInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "sources.yipyap.run.YipYapSource"),
	)
