...
// SourcesV1alpha1Client is used to interact with features provided by the sources.yipyap.run group.
type SourcesV1alpha1Client struct {
	restClient rest.Interface
}

func (c *SourcesV1alpha1Client) YipYapSources(namespace string) YipYapSourceInterface {
	return newYipYapSources(c, namespace)
}
